...
public class ControllerLogger {
    ...
    @Before("execution(public * com.lantern_business_webpp.controller.*.*(..))")
    ...
    @After("execution(public * com.lantern_business_webpp.controller.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.lantern_business_webpp.controller.*.*(..))", throwing = "error")
