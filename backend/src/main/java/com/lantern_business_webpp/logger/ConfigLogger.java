...
public class ConfigLogger {
    ...
    @Before("execution(public * com.lantern_business_webpp.configuration.*.*(..))")
    ...
    @After("execution(public * com.lantern_business_webpp.configuration.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.lantern_business_webpp.configuration.*.*(..))", throwing = "error")
