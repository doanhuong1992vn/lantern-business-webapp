...
public class ExceptionLogger {
    ...
    @Before("execution(public * com.lantern_business_webpp.exception.*.*(..))")
    ...
    @After("execution(public * com.lantern_business_webpp.exception.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.lantern_business_webpp.exception.*.*(..))", throwing = "error")
