...
public class SecurityLogger {
    ...
    @Before("execution(public * com.lantern_business_webapp.security.*.*(..))")
    ...
    @After("execution(public * com.lantern_business_webapp.security.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.lantern_business_webapp.security.*.*(..))", throwing = "error")
