...
public class ServiceLogger {
    ...
    @Before("execution(public * com.lantern_business_webapp.service.*.*(..))")
    ...
    @After("execution(public * com.lantern_business_webapp.service.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.lantern_business_webapp.service.*.*(..))", throwing = "error")
