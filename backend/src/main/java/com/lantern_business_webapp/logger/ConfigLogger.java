...
public class ConfigLogger {
    ...
    @Before("execution(public * com.lantern_business_webapp.configuration.*.*(..))")
    ...
    @After("execution(public * com.lantern_business_webapp.configuration.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.lantern_business_webapp.configuration.*.*(..))", throwing = "error")
