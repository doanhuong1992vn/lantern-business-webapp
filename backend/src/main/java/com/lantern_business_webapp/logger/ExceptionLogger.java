...
public class ExceptionLogger {
    ...
    @Before("execution(public * com.lantern_business_webapp.exception.*.*(..))")
    ...
    @After("execution(public * com.lantern_business_webapp.exception.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.lantern_business_webapp.exception.*.*(..))", throwing = "error")
